...
const MIXES: Record<RiskProfile, AssetMixSlice[]> = {
  conservative: [
    ...
    { name: "Index ETFs", value: 20, color: "#00E0B8" },
    { name: "UAE Equities", value: 10, color: "#D4AF37" },
  ],
  balanced: [
    { name: "Index ETFs", value: 50, color: "#00E0B8" },
    { name: "Bonds", value: 25, color: "#6366F1" },
    { name: "UAE Equities", value: 15, color: "#D4AF37" },
    { name: "Cash", value: 10, color: "#64748B" },
  ],
  aggressive: [
    { name: "Index ETFs", value: 55, color: "#00E0B8" },
    { name: "UAE Equities", value: 30, color: "#D4AF37" },
